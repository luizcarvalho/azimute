...
class Vincent
  def initialize(lat1, lon1)
    ...
    @a = 6_378_137 # Maior semi-eixo da Elipsóide Terrestre - WGS66 (1966)[EUA/DoD]
    @b = 6_356_752.3142 # Maior semi-eixo da Elipsóide Terrestre - WGS66 (1966)[EUA/DoD]
  ...
  def calculate(az, dist)
    ...
    an = 1 + u_sq / 16_384 * (4096 + u_sq * (-768 + u_sq * (320 - 175 * u_sq)))
    ...
    { lat: todeg(lat2), lon: @lon1 + todeg(ln), rev_az: }
  end
end
